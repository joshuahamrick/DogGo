...
public ActionResult Index()
        {
            List<Walker> walkers = _context.Walkers.ToList();
        ...
        {
            Walker walker = _context.Walkers.SingleOrDefault(w => w.Id == id);
        ...
        // POST: Walkers/Edit/5
        // To protect from overposting attacks, enable th e specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
